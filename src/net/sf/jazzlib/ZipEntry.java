...
public class ZipEntry implements ZipConstants
{
  ...
  public Object clone()
  {
    ZipEntry result = new ZipEntry(this.name);

    result.size = this.size;
    result.compressedSize = this.compressedSize;
    result.crc = this.crc;
    result.dostime = this.dostime;
    result.known = this.known;
    result.method = this.method;

    result.extra = this.extra;
    result.comment = this.comment == null ? null : new String(this.comment);
   ...
   * of the name.  Remark that the equals method isn't changed, though.
   */
  public int hashCode()
  {
